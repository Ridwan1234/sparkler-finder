  ...
  return (
    <section id="faq" className="py-20 lg:py-28 section-dark">
      <div className="container max-w-3xl">
        ...
        >
          <span className="text-primary font-medium text-sm uppercase tracking-wider">{t("faq.label")}</span>
          <h2 className="text-3xl md:text-4xl font-display font-bold mt-3 mb-4">{t("faq.title")}</h2>
        </motion.div>
